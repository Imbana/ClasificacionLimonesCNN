...
def main():
    ...
    pathFolder=('/home/pi/Documents/RaspberryLite/Acaros')
    contenidoFotos=os.listdir(pathFolder)
    ...
    #    image = frame.array 
    for pathFoto in contenidoFotos:
        
        nuevaImg=os.path.join(pathFolder,pathFoto)
        
        frame1=cv2.imread(nuevaImg)
        ...
        #imagen.shape=(1,224,224,3)
        Imagen_show = cv2.resize(frame1, (600, 600))
